...
jest.mock("../../Pages/CVBuilder", () => () => (
  <div data-testid="cv-builder">CV Builder</div>
));
jest.mock("../../Pages/MessagingSystem", () => () => (
  <div data-testid="messaging-system">Messaging System</div>
));
...
describe("StudentDashboard", () => {
  ...
  test("renders basic dashboard elements", () => {
    ...
    expect(
      screen.getByText("Find Suitable Internships and Apply with ease"),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByText("Based on your profile and preferences"),
    ).toBeInTheDocument();
