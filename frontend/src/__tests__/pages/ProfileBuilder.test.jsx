...
describe('ProfileBuilder', () => {
  test('renders basic profile elements', () => {
    ...
    expect(screen.getByPlaceholderText('Write a brief professional summary...')).toBeInTheDocument();

    // Test basic buttons exist
    expect(screen.getByRole('button', { name: 'Save Changes' })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: 'Preview Profile' })).toBeInTheDocument();
  });
