        ...
        <MemoryRouter initialEntries={[initialRoute]}>
          <Routes>
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  component={() => <div>Student Dashboard</div>}
                />
              }
            />
            <Route
              path="/profile"
              element={
                <ProtectedRoute component={() => <div>Profile Page</div>} />
              }
            />
            <Route
              path="/company"
              element={
                <ProtectedRoute
                  component={() => <div>Company Dashboard</div>}
                />
              }
            />
            <Route
              path="/admin"
              element={
                <ProtectedRoute component={() => <div>Admin Dashboard</div>} />
              }
            />
