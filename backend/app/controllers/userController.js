const { registerStudent, registerRecruiter, findStudent, findRecruiter } = require("../services/userService");
...
const registerUser = async (req, res) => {
    try {
        ...
        if(userType === 'student') {
            ...
            const user = await registerStudent({ firstName, lastName, email, mobileNumber, dateOfBirth, gender, profilePicture, linkedinProfile, githubProfile });
