...
\begin{document}
    ...
    \puttitle{
        title=Software Engineering 2\\Implementation \& Test Delieverable,
...
% TABLE OF CONTENTS
    ...
    \input{Chapters/2_-_Implemented_Requirements}


    \chapter{Design Choices}
    \label{ch:user_interface_design}%
    \input{Chapters/3_-_Design_Choices}

    \chapter{Source Code Stucture} \label{ch:requirements_tracability}%
    \input{Chapters/4_-_Source_Code_Structure}

 \chapter{Testing}
\label{ch:implementation_integration_test_plan}
\input{Chapters/5_-_Testing}

    \chapter{Installation Instructions}
    \label{ch:effort_spent}%
    \input{Chapters/6_-_Installation_Instructions}

     \chapter{Effort Spent}
    \label{ch:effort_spents}%
    \input{Chapters/8._-_Effort_Spent}
